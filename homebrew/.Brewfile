...
cask "font-monaspice-nerd-font" # Monaspice Nerd Font family
cask "font-symbols-only-nerd-font" # Symbols-only Nerd Font family
...
brew "hblock" # Adblocker that creates a hosts file from multiple sources
brew "htop" # Improved top (interactive process viewer)
brew "jq" # Lightweight and flexible command-line JSON processor
#brew "kubefwd" # Bulk port forwarding Kubernetes services for local development
...
mas "DaisyDisk", id: 411643860 # Disk space visualizer
