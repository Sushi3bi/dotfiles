...
---  },
---}
---color.set_scheme(Config, theme, "tokyonight-moon")
---~~~
M.color = {}
...
--~~ {{{2 M.color.get_scheme() -> "tokyonight-moon"|"tokyonight-day"
...
---detected as "Dark," it returns `"tokyonight-moon"`.  Otherwise, it defaults to
---`"tokyonight-day"`.
---
---@return "tokyonight-moon"|"tokyonight-day" colorscheme
---
---@usage
---~~~lua
-----Example usage
